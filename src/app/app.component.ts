      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="invalid-feedback">Du måste svara Ja eller Nej</div>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <select formControlName="country" [appDisabled]="form.get('country')" [disable]="pnrFilled$ | async">
            ...
            <div class="invalid-feedback">Du måste ange ett land</div>
          </div>
        </div>
        <div class="row">
          <div class="col">
